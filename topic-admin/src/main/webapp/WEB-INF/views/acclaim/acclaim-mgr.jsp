...
<div class="row-fluid">
        ...
        <div class="portlet-body" style="display: none;">
            <form id="queryForm" action="#" class="form form-horizontal">
                <div class="row-fluid">
                    ...
                    <div class="control-group  ">
                        <label class="control-label">点赞对象:</label>
                        <div class="controls">
    ...
    <div class="portlet box blue" id="J_result">
        ...
        <div class="portlet-body">
            <div id="acclaim-grid"></div>
        </div>
    </div>
</div>
    <%@ include file="acclaim-add.jsp"%>
<!-- END 右容器 main-->
 <script src="${ctx}/static/js/acclaim/acclaim-add.js" type="text/javascript"></script>
<script src="${ctx}/static/js/acclaim/acclaim-mgr.js" type="text/javascript"></script>
</body>
</html>
