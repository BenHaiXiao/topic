 ...
 *
 */
public class FolderFollowStore {

    private static final Logger LOG = LoggerFactory.getLogger(FolderFollowStore.class);

    private MongoTemplate followMongoTemplate;

    private static final String COLLECTION = "folder_follow";

    public FolderFollowStore(MongoTemplate followMongoTemplate) {
