 ...
 *
 */
public class ArticleAcclaimStore {

    private static final Logger LOG = LoggerFactory.getLogger(ArticleAcclaimStore.class);

    private MongoTemplate acclaimMongoTemplate;

    private static final String COLLECTION = "article_acclaim";

    public ArticleAcclaimStore(MongoTemplate acclaimMongoTemplate) {
